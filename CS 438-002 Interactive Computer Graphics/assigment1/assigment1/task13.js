...
var lastname = 'Marku';
var firstname = 'Baudin';
var studentnum = '31460156';
// ----------------------------------------------------------------------------
...
function main() {
    ...
    gl.bindBuffer(gl.ARRAY_BUFFER, triangleVertexBufferObject);
     ...
     //In particular you need to take care of the size, stride, and offset values of the buffer. 
        ...
        // Code changes explained in the documentation

        // Turn on the position attribute
        gl.enableVertexAttribArray(positionAttribLocation);
        // Tell the position attribute how to get data out of triangleVertexBuffer (ARRAY_BUFFER)
        var size = 3;						                // number of elements per attribute, it is a vec3 thus 3.
        ...
        var stride = 6 * Float32Array.BYTES_PER_ELEMENT;	// size of an individual vertex (6 floats = 3 pos, 3 color)
    ...
    function render() {
        ...
        gl.clear(gl.COLOR_BUFFER_BIT);
         ...
         //the new vertex buffer object (VBO) which now contains 3d-floating point positions.         
            ...
            // geometry.length / 6 to handle 6 floats per point
